...
#define CONFIG_SYS_LOAD_ADDR            0x8000		/*bootm的默认地址*/
...
#define CONFIG_SYS_SDRAM_BASE   0	//是SDRAM的基址0
#define CONFIG_NR_DRAM_BANKS    2     // there are 2 sdram banks for nuc970
#define CONFIG_SYS_INIT_SP_ADDR 0xBC008000	//估计是内部64kram的地址
...
1、可以在uboot中定义(上面)设置
2、通过环境参数传入mtdparts参数设置
3、通过修改kernel中flash分区信息设置
...
#define CONFIG_CMD_MYLED
#define CONFIG_WDT_KEY_LED
#define CONFIG_CMD_UART_TEST
#define CONFIG_CONSOLE_USED_UART  0	//0-8
